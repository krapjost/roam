:PROPERTIES:
:ID:       3886eacc-9064-49bb-b724-69a1c029ffcd
:END:
#+title: 221123142843 Cognitect_dev_tools_설정 Ko
#+title: cognitect dev-tools 설정
#+hugo_base_dir: ~/blog
#+hugo_section: ../content_ko/posts
#+hugo_publishdate: <2022-11-23 Wed 14:28>
#+hugo_front_matter_format: yaml
#+hugo_auto_set_lastmod: t
#+filetags: @clojure

datomic을 로컬에서 테스트 해보려면 ~com.datomic:dev-local~ 라이브러리가 필요한데 이는 공개 저장소에서 받을 수 없다.
[[https://cognitect.com/dev-tools][dev-tools 링크]]에서 이메일 입력하면 다운로드 링크를 보내준다.
